...
import { Coffee, User, Mail, Lock, ArrowLeft, CheckCircle, Copy } from 'lucide-react';
...
export function SignupScreen({ onSignup, onBackToLogin }: SignupScreenProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await signUp(username.trim(), email.trim() || null, passcode, false);
        ...
        <Card className="border-border/50 shadow-card">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <div>
                <CardTitle className="font-display">New Account</CardTitle>
                <CardDescription>
                  Join the team with your own credentials.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Create your secret passcode"
      ...
      <Dialog open={showSuccess} onOpenChange={setShowSuccess}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogTitle className="text-center font-display">Account Created!</DialogTitle>
